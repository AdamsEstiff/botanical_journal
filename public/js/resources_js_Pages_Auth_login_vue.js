...
var render = function() {
  ...
  return _c(
    "el-row",
    { staticClass: "mt-5 father", attrs: { gutter: 24 } },
    [
      _c("el-col", { attrs: { span: 8, xl: 8, lg: 8, md: 6, sm: 6, xs: 2 } }, [
        _c("p", { staticClass: "space" }, [_vm._v("space")])
      ]),
      _vm._v(" "),
      _c(
        "el-col",
        { attrs: { span: 8, xl: 8, lg: 8, md: 12, sm: 12, xs: 22 } },
        [
          _c(
            "el-card",
            [
              _c("div", { attrs: { slot: "header" }, slot: "header" }, [
                _c("div", { staticClass: "logo-container" }, [
                  _c("img", {
                    ...
                    attrs: { src: "/images/logos/logo.PNG" }
                  })
                ])
              ]),
              _vm._v(" "),
              ...
              _c("el-col", { attrs: { span: 24 } }, [
                Object.entries(_vm.$page.props.auth.errors).length !== 0
                  ? _c(
                      "span",
                      [
                        _c(
                          ...
                          [
                            _vm._v(
                              _vm._s(_vm.$page.props.auth.errors[0][0]) +
                                "\n                    "
                            )
                          ]
                        )
              ...
              _c(
                "el-col",
                { staticClass: "mb-1 mt-1", attrs: { span: 24 } },
                [
                  _c(
                    "el-button",
                    {
                      attrs: { type: "primary", icon: "fas fa-sign-in-alt" },
                      on: { click: _vm.login }
                    },
